...
func GridView(
	...
	pacman, pacmanErr := tool.ScaleSprite(characters.Pacman, 0.5, 0.5)
	if pacmanErr != nil {
		return nil, pacmanErr
	}

	//ghost1, ghost1Err := tool.ScaleSprite(characters.Ghost1, 0.5, 0.5)
	//if ghost1Err != nil {
	//	return nil, ghost1Err
	//}
	//
	//ghost2, ghost2Err := tool.ScaleSprite(characters.Ghost2, 0.5, 0.5)
	//if ghost2Err != nil {
	//	return nil, ghost2Err
	//}
	//
	//ghost3, ghost3Err := tool.ScaleSprite(characters.Ghost3, 0.5, 0.5)
	//if ghost3Err != nil {
	//	return nil, ghost3Err
	//}
	//
	//ghost4, ghost4Err := tool.ScaleSprite(characters.Ghost4, 0.5, 0.5)
	//if ghost4Err != nil {
	//	return nil, ghost4Err
	//}

	//life, lifeErr := tool.ScaleSprite(powers.Life, 0.5, 0.5)
	//if lifeErr != nil {
	//	return nil, lifeErr
	//}
	//
	//invinci, invinciErr := tool.ScaleSprite(powers.Invincibility, 0.5, 0.5)
	//if invinciErr != nil {
